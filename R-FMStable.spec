...
Version  : 0.1.4
Release  : 45
URL      : https://cran.r-project.org/src/contrib/FMStable_0.1-4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/FMStable_0.1-4.tar.gz
...
%setup -q -n FMStable
pushd ..
cp -a FMStable buildavx2
popd
pushd ..
cp -a FMStable buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737144389
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/FMStable/libs/FMStable.so
/V4/usr/lib64/R/library/FMStable/libs/FMStable.so
